    ...
    def create_chat_screen(initial_command=None):
        ...
        def process_command(command_text):
            ...
            if command in ["kur", "dolar", "euro"]:
                ...
                fallback_dialogues = [
                    ...
                    f"Patron, bu konuyu menüdeki 'Rehber' kısmından veya 'komutlar' yazarak detaylıca inceleyebilirsin."
                ]
        ...
        app_bar = ft.Container(
            content=ft.Row([
                ...
                ft.Text("North AI - Sohbet & Diyalog", size=15, weight=ft.FontWeight.BOLD, color="#ffffff"),
                ft.Text("v0.8.8", size=11, color="#8b9bb4")
            ], alignment=ft.MainAxisAlignment.SPACE_BETWEEN),
